...
class PropagandaPage extends StatelessWidget {
  final Controller controller = Get.find<Controller>();
  final List<String> _listitem = [
    'assets/imagens/icon_wifi.png',
    'assets/imagens/icon_tv.png',
    'assets/imagens/icon_jornal.png',
    'assets/imagens/icon_radio.png',
  ];
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                              ...
                              color: Colors.grey[400],
                              onPressed: () {
                                controller.user.value.saldo = 2000.00;
                              },
                              child: Text(
                                "Pular",
                                style: TextStyle(
